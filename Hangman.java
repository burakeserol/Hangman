public class Hangman
{
  ...
  public int tryThis(char letter)
  {
    ...
    if (existsIn(this.usedLetters, letter)) {
      return -2;
    } 
    ...
    if (!existsIn(this.allLetters, letter)) {
      return -3;
    } 
  ...
  public boolean isGameOver() {
    return (hasLost()) || (isComplete());
  } 
  
  private boolean isComplete()
  {
    return !existsIn(this.knownSoFar, this.blankChar);
  } 
